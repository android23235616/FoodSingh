...
public class constants {
    ...
    public static final String check_mobile="http://foodsingh.com/app_files/user/check_mobile.php";

    public static final String main_url = "http://foodsingh.com/app_files/user/get_data.php";
    public static final String service_status_url = "http://foodsingh.com/app_files/user/get_service_status.php";
    public static final String token_url = "http://foodsingh.com/app_files/user/update_token.php";
    public static final String order_details = "http://foodsingh.com/app_files/user/get_order_details.php";

    //yahan pe chnange kr
    public static String login_details_url="http://foodsingh.com/app_files/user/logini_save_and_check.php";
    public static String login_check_url="http://foodsingh.com/app_files/user/login.php";

    public static String coupon_url="http://foodsingh.com/app_files/user/check_coupon3.php";
    ...
    public static String discount_coupon="http://foodsingh.com/app_files/user/get_discount.php";
    public static String forgot_password="http://foodsingh.com/app_files/user/forgot_password.php";
    public static String update_details="http://foodsingh.com/app_files/user/update_user_data.php";
    public static String get_details="http://foodsingh.com/app_files/user/get_user_data.php";

    public static String get_service_status="http://foodsingh.com/app_files/user/get_service_status.php";
